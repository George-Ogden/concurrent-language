...
class Status {
    static inline constexpr std::size_t OWNER_IDX = 0;
    static inline constexpr std::size_t OWNER_WIDTH = 8;
    ...
    AtomicSharedEnum<OWNER_WIDTH, REQUIRED_WIDTH, DONE_WIDTH> value;
